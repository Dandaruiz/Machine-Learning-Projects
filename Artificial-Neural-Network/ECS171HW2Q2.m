...
[firstA,firstW,firstPrediction,errorTrain,errorTest,accuracyTrain,accuracyTest,weightsNode1,outputNodes,predictionTrain,predictionTest] = neuralNetwork(xTrain,yTrain,epochs,alpha,zeros(size(xTrain)),zeros(length(xTrain),10),numLayers,numNodes);
